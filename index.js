...
function get20s(array){
  ...
  if (parseInt(`${array[i].years}`.slice(0,4)) >= 1900 && parseInt(`${array[i].years}`.slice(7,11)) <= 2000) {
...
function addArtist(array){
  ...
  array.push({id: 20,
    ...
    bio: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor llamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum'});
